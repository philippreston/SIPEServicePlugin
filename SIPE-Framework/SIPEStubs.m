...
#pragma mark  -
#pragma mark SIPE C Backend CHAT Functions
#pragma mark  -
//===============================================================================
// SIPE C Backend CHAT Functions
//===============================================================================
...
gboolean sipe_backend_chat_find(SIPE_UNUSED_PARAMETER struct sipe_backend_chat_session *backend_session,
                                SIPE_UNUSED_PARAMETER const gchar *uri)  { return NO; };
...
#pragma mark  -
#pragma mark SIPE C Backend MARKUP Functions
#pragma mark  -
//===============================================================================
// SIPE C Backend MARKUP Functions
//===============================================================================
gchar *sipe_backend_markup_css_property(SIPE_UNUSED_PARAMETER const gchar *style,
                                        SIPE_UNUSED_PARAMETER const gchar *option) { return NULL; }
gchar *sipe_backend_markup_strip_html(SIPE_UNUSED_PARAMETER const gchar *html) { return NULL; }


#pragma mark  -
#pragma mark SIPE C Backend MEDIA Functions
#pragma mark  -
//===============================================================================
// SIPE C Backend MEDIA Functions
//===============================================================================
...
#pragma mark  -
#pragma mark SIPE C Backend NOTIFICATIONS Functions
#pragma mark  -
//===============================================================================
// SIPE C Backend NOTIFICATIONS Functions
//===============================================================================
...
#pragma mark  -
#pragma mark SIPE C Backend BUDDIES Functions
#pragma mark  -
//===============================================================================
// SIPE C Backend BUDDIES Functions
//===============================================================================
